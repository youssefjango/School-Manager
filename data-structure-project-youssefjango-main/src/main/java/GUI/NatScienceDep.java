...
/**
 * The Natural Science Depratment panel.
 *
 * @author YOUSSEF
 */
public class NatScienceDep extends javax.swing.JFrame {

    private final static String PATH_OF_DEP = "Database\\Science.txt";

    /**
     * Creates new form EnglishDep
     */
    public NatScienceDep() {
        initComponents();
        nameLabels();
        startTables();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Natural Science Departement");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(hoursPerWeekTeacherAdder, javax.swing.GroupLayout.DEFAULT_SIZE, 15, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTextArea2.setText("Natural Science Departement");
    ...
    private void addStaffButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addStaffButtonActionPerformed
        try {
            ...
            Departement dScience = DataConvertor.convertToObjects(PATH_OF_DEP);
            ...
            dScience.getStaffs().add(newStaff);
            DataConvertor.convertToFile(dScience, PATH_OF_DEP);
            modelStaff = (DefaultTableModel) staffTable.getModel();
            modelTeacher = (DefaultTableModel) teacherTable.getModel();
            modelStaff.setRowCount(0);
            modelTeacher.setRowCount(0);
    ...
    private void addTeacherButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTeacherButtonActionPerformed
        try {
            ...
            dScience.getTeachers().add(teacher);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NatScienceDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
