...
/**
 * The Social Sciences Depratment panel.
 *
 * @author YOUSSEF
 */
public class SocialScienceDep extends javax.swing.JFrame {

    private final static String PATH_OF_DEP = "Database\\Social Science.txt";

    /**
     * Creates new form EnglishDep
     */
    public SocialScienceDep() {
        initComponents();
        nameLabels();
        startTables();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Social Science Departement");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(hoursPerWeekTeacherAdder, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTextArea2.setText("Social Science Departement");
    ...
    private void addStaffButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addStaffButtonActionPerformed
        try {
            ...
            Departement dSocialScience = DataConvertor.convertToObjects(PATH_OF_DEP);
            ...
            Departement dMusic = DataConvertor.convertToObjects("Database\\Music.txt");
            ...
            dSocialScience.getStaffs().add(newStaff);
            DataConvertor.convertToFile(dSocialScience, PATH_OF_DEP);
            modelStaff = (DefaultTableModel) staffTable.getModel();
            modelTeacher = (DefaultTableModel) teacherTable.getModel();
            modelStaff.setRowCount(0);
            modelTeacher.setRowCount(0);
            ...
            JOptionPane.showMessageDialog(null, "There is already one staff in the school with that ID.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
        nameLabels();
    ...
    private void addTeacherButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTeacherButtonActionPerformed
        try {
            ...
            dSocialScience.getTeachers().add(teacher);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SocialScienceDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
