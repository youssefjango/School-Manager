 ...
 * @author YOUSSEF
 */
public class EnglishDep extends javax.swing.JFrame {

    private final static String PATH_OF_DEP = "Database\\English.txt";
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("English Departement");
    ...
    private void addStaffButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addStaffButtonActionPerformed
        try {
            ...
            Departement dEnglish = DataConvertor.convertToObjects(PATH_OF_DEP);
            ...
            dEnglish.getStaffs().add(newStaff);
            DataConvertor.convertToFile(dEnglish, PATH_OF_DEP);
            modelStaff = (DefaultTableModel) staffTable.getModel();
            modelTeacher = (DefaultTableModel) teacherTable.getModel();
            modelStaff.setRowCount(0);
            modelTeacher.setRowCount(0);
    ...
    private void addTeacherButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addTeacherButtonActionPerformed
        try {
            ...
            dEnglish.getTeachers().add(teacher);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnglishDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
